...
// ------------------------------------------------------
  ...
  return (
    ...
    <div className='container' style={{color: props.mode=== 'dark'?'white': 'black'}}>
        ...
        <h1>{props.heading}</h1>
        <button type='button' style={{borderRadius: '50%'}} id='mic' onClick={handleToggleListen} data-bs-toggle="tooltip" data-bs-placement="auto" title="Voice Typing" className={`btn btn-${props.theme} ${isListening?'mic-icon': ''} mx-1 my-auto`}>{isListening?<i className="bi bi-mic-fill"></i>: <i className="bi bi-mic"></i>}</button>
        </form>
        <div className="mb-3">
        ...
        <button className={`btn btn-${props.theme} mx-1 my-1`} onClick={handlePaste}>Paste</button>
        ...
        <button type="button" disabled={text.length === 0} className={`btn btn-${props.theme} mx-1 my-1`} onClick={handleEncodeClick}>{isEncoded ? 'Decode' : 'Encode'}</button>

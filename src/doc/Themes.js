...
export default function Themes(props) {
  return (
    ...
    <div className="form-check form-check-inline ml-0 mb-sm-2 mb-md-2 mb-lg-0 mx-0">
        <input className="btn-check" value="primary" onClick={(e) => props.toggleTheme(e.target.value)} type="radio" name='flexDefault' id="btn-check-outlined1" autoComplete='off' checked={props.theme === 'primary'}/>
        <label className="btn btn-outline-primary" htmlFor="btn-check-outlined1"></label>
    </div>
    <div className="form-check form-check-inline mx-0">
        <input className="btn-check" value="success" onClick={(e) => props.toggleTheme(e.target.value)} type="radio" name='flexDefault' id="btn-check-outlined2" autoComplete='off' checked={props.theme === 'success'}/>
        <label className="btn btn-outline-success" htmlFor="btn-check-outlined2"></label>
    </div>
    <div className="form-check form-check-inline mx-0">
        <input className="btn-check" value="warning" onClick={(e) => props.toggleTheme(e.target.value)} type="radio" name='flexDefault' id="btn-check-outlined4" autoComplete='off' checked={props.theme === 'warning'}/>
        <label className="btn btn-outline-warning" htmlFor="btn-check-outlined4"></label>
    </div>
    <div className="form-check form-check-inline mr-2">
        <input className="btn-check" value="danger" onClick={(e) => props.toggleTheme(e.target.value)} type="radio" name='flexDefault' id="btn-check-outlined5" autoComplete='off' checked={props.theme === 'danger'}/>
